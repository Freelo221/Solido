...
$(document).ready(function() {
    ...
    ToggleTooltip = (val) => {
        val ? $("#tooltipContainer").css("display", "block") : $("#tooltipContainer").css("display", "none");
    }

    ToggleLinkElementOption = (val) => {
        val ? $("#linkElementContainer").css("display", "block") : $("#linkElementContainer").css("display", "none");
    }
    ...
    $("#inputChildNodeTooltip").on("change", function(e) {
        ToggleTooltip(this.checked);
        // if (this.checked) {
        //     $("#InfoOption").css("display", "flex");
        // } else {
        //     $("#InfoOption").css("display", "none");
    ...
    $("#inputChildNodeLinkElements").on("change", function(e) {
        ToggleLinkElementOption(this.checked);
        // if (this.checked) {
        //     $("#InfoOption").css("display", "flex");
        // } else {
        //     $("#InfoOption").css("display", "none");
...
function OpenParentElementInEditor(parent) {
    ...
    document.querySelector("#inputParentNodeShipping").checked = parent.isShippingElement
}
...
function UpdateParentElement() {
    ...
    SelectedParent.isShippingElement = document.querySelector("#inputParentNodeShipping").checked
...
function OpenChildElementInEditor(ChildElement) {
    ...
    SelectedChild.isCheckbox ? document.querySelector("#inputChildNodeDisplayCheckbox").checked = true : document.querySelector("#inputChildNodeDisplayCheckbox").checked = false
        // document.querySelector("#inputChildNodeDisplayCheckbox").checked = SelectedChild.displayCheckbox
    ...
    SelectedChild.preventUpgradeDeselect ? document.querySelector("#inputChildNodeUpgradePrevent").checked = true : document.querySelector("#inputChildNodeUpgradePrevent").checked = false;
    ...
    SelectedChild.showTooltip ? document.querySelector("#inputChildNodeTooltip").checked = true : document.querySelector("#inputChildNodeTooltip").checked = false;
    ToggleTooltip(SelectedChild.showTooltip);


    SelectedChild.linkElements ? document.querySelector("#inputChildNodeLinkElements").checked = true : document.querySelector("#inputChildNodeLinkElements").checked = false;
    ToggleLinkElementOption(SelectedChild.linkElements)

    SelectedChild.selectLinkElements ? document.querySelector("#inputChildNodeSelectElements").value = SelectedChild.selectLinkElements : document.querySelector("#inputChildNodeSelectElements").value = ""
    SelectedChild.deselectLinkElements ? document.querySelector("#inputChildNodeDeselectElements").value = SelectedChild.deselectLinkElements : document.querySelector("#inputChildNodeDeselectElements").value = ""

    SelectedChild.imageCode ? document.querySelector("#inputChildNodeImageCode").value = SelectedChild.imageCode : document.querySelector("#inputChildNodeImageCode").value = ""




    SelectedChild.changeByColor ? document.querySelector("#inputChildNodeChangeImageByColor").checked = true : document.querySelector("#inputChildNodeChangeImageByColor").checked = false

    document.querySelector("#inputTooltipText").value = SelectedChild.tooltipText;
    ...
    document.querySelector("#inputChildNodeInfoText").value = htmlDecode(SelectedChild.infoText);
...
function UpdateChildElement() {
    ...
    SelectedChild.isCheckbox = document.querySelector("#inputChildNodeDisplayCheckbox").checked
    ...
    SelectedChild.preventUpgradeDeselect = document.querySelector("#inputChildNodeUpgradePrevent").checked;
    ...
    SelectedChild.showTooltip = document.querySelector("#inputChildNodeTooltip").checked
        // ToggleTooltip(SelectedChild.showTooltip);

    SelectedChild.tooltipText = document.querySelector("#inputTooltipText").value

    SelectedChild.changeByColor = document.querySelector("#inputChildNodeChangeImageByColor").checked


    SelectedChild.linkElements = document.querySelector("#inputChildNodeLinkElements").checked

    SelectedChild.selectLinkElements = document.querySelector("#inputChildNodeSelectElements").value
    SelectedChild.deselectLinkElements = document.querySelector("#inputChildNodeDeselectElements").value

    SelectedChild.imageCode = document.querySelector("#inputChildNodeImageCode").value
    ...
    SelectedChild.infoText = htmlEncode(document.querySelector("#inputChildNodeInfoText").value);
