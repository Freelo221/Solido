...
var rinne_end;
var rinne_ueberstand_eingerueckt_end;
var rinne_ueberstand_end;
var rinne_ueberstand_start;
var rinne_repeat;
var rinne_start;

var designrinne_eingerueckt_end;
var designrinne_end;
var designrinne_ueberstand_eingerueckt_end;
var designrinne_ueberstand_end;
var designrinne_ueberstand_start;
var designrinne_repeat;
var designrinne_start;
...
export const LoadGLTFFile = (file) => {
    return new Promise(function(resolve, reject) {
        gltfloader.load("models/maderos/" + file, (file) => resolve(file));
...
export function GetInternFile(_objName) {
    ...
    return new Promise((resolve, reject) => {
        ...
        } else if (objName == "rinne_ueberstand_eingerueckt_end.fbx") {
            if (rinne_ueberstand_eingerueckt_end != null && rinne_ueberstand_eingerueckt_end != undefined) {
                value = rinne_ueberstand_eingerueckt_end;
                resolve(value);
            } else {
                LoadFBXFile('rinne_ueberstand_eingerueckt_end.FBX').then((e) => {
                    rinne_ueberstand_eingerueckt_end = e;
                    value = e;
                    resolve(value);
                });
        ...
        } else if (objName == "rinne_ueberstand_end.fbx") {
            if (rinne_ueberstand_end != null && rinne_ueberstand_end != undefined) {
                value = rinne_ueberstand_end;
                resolve(value);
            } else {
                LoadFBXFile('rinne_ueberstand_end.FBX').then((e) => {
                    rinne_ueberstand_end = e;
                    value = e;
                    resolve(value);
                });
        ...
        } else if (objName == "rinne_ueberstand_start.fbx") {
            if (rinne_ueberstand_start != null && rinne_ueberstand_start != undefined) {
                value = rinne_ueberstand_start;
                resolve(value);
            } else {
                LoadFBXFile('rinne_ueberstand_start.FBX').then((e) => {
                    rinne_ueberstand_start = e;
                    value = e;
                    resolve(value);
                });
        ...
        } else if (objName == "designrinne_eingerueckt_end.fbx") {
            if (designrinne_eingerueckt_end != null && designrinne_eingerueckt_end != undefined) {
                value = designrinne_eingerueckt_end;
                resolve(value);
            } else {
                LoadFBXFile('designrinne_eingerueckt_end.FBX').then((e) => {
                    designrinne_eingerueckt_end = e;
                    value = e;
                    resolve(value);
                });
        ...
        } else if (objName == "designrinne_end.fbx") {
            if (designrinne_end != null && designrinne_end != undefined) {
                value = designrinne_end;
                resolve(value);
            } else {
                LoadFBXFile('designrinne_end.FBX').then((e) => {
                    designrinne_end = e;
                    value = e;
                    resolve(value);
                });
        ...
        } else if (objName == "designrinne_ueberstand_eingerueckt_end.fbx") {
            if (designrinne_ueberstand_eingerueckt_end != null && designrinne_ueberstand_eingerueckt_end != undefined) {
                value = designrinne_ueberstand_eingerueckt_end;
                resolve(value);
            } else {
                LoadFBXFile('designrinne_ueberstand_eingerueckt_end.FBX').then((e) => {
                    designrinne_ueberstand_eingerueckt_end = e;
                    value = e;
                    resolve(value);
                });
        ...
        } else if (objName == "designrinne_ueberstand_end.fbx") {
            if (designrinne_ueberstand_end != null && designrinne_ueberstand_end != undefined) {
                value = designrinne_ueberstand_end;
                resolve(value);
            } else {
                LoadFBXFile('designrinne_ueberstand_end.FBX').then((e) => {
                    designrinne_ueberstand_end = e;
                    value = e;
                    resolve(value);
                });
        ...
        } else if (objName == "designrinne_ueberstand_start.fbx") {
            if (designrinne_ueberstand_start != null && designrinne_ueberstand_start != undefined) {
                value = designrinne_ueberstand_start;
                resolve(value);
            } else {
                LoadFBXFile('designrinne_ueberstand_start.FBX').then((e) => {
                    designrinne_ueberstand_start = e;
                    value = e;
                    resolve(value);
                });
        ...
        } else if (objName == "designrinne_repeat.fbx") {
            if (designrinne_repeat != null && designrinne_repeat != undefined) {
                value = designrinne_repeat;
                resolve(value);
            } else {
                LoadFBXFile('designrinne_repeat.FBX').then((e) => {
                    designrinne_repeat = e;
                    value = e;
                    resolve(value);
                });
        ...
        } else if (objName == "designrinne_start.fbx") {
            if (designrinne_start != null && designrinne_start != undefined) {
                value = designrinne_start;
                resolve(value);
            } else {
                LoadFBXFile('designrinne_start.FBX').then((e) => {
                    designrinne_start = e;
                    value = e;
                    resolve(value);
                });
