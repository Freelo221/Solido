 ...
 <div class="swiper">
							...
							<div class="col-12 col-sm-6">
								...
								<p id="modalOptionBox_text" class="mt-4">
									...
									Platz: Wir finden die Lösung, die genau zu Ihrem Haus passt.
									Wir fertigen Terrassendächer maßgeschneidert nach Ihren
				...
				<div class="content">
				  ...
				  <img src="./img/logo.svg" alt="" />
							...
							<div class="infoText mt-5 mb-5">
								<p>
									Die Lieferzeit beträgt ca. 3 - 4 Wochen. Alle konfigurierbaren
									Terrassendächer sind auf eine Schneelast von mindestens sk= 0,65
									kN/m² (Schneelastzone1) ausgelegt. Bei höheren Schneelastzonen
									ist ggf. eine statische Anpassung des Dachs notwendig.
								</p>
								<p>
									Die statische Berechnung gilt für den privaten Bereich (0,5
									KN/m). Der maximale Pfostenabstand darf 1m nicht überschreiten.
									Dies stellt einen unverbindlichen Konfigurationsvorschlag dar.
									Je nach örtlichen Begebenheiten oder der Art der
									Zusammenstellung kann es im Auftragsfall zu Abweichungen kommen.
								</p>
								<p>
									Alle Maße sind ca. Angaben ohne Gewähr. Da es sich um
									theoretische Werte handelt, müssen bauseits Toleranzen
									einkalkuliert werden.
								</p>
								<p class="befestignungsNotice mt-3">Hinweis: Es gibt verschiedene Mauerwerke - man extra Befestigungsmaterial benötigt; </p>
							</div>
						</div>
					</div>
					<div class="row">
							...
							<div class="row"> 
								...
								<div class="col-3 position-relative previewImage">
									<div class="dimensionInfoBox">
										...
										<div>A &nbsp;&nbsp; Durchgangshöhe &nbsp;&nbsp;<span class="outputDurchgangsHeight">2000mm</span></div>
										<div>B &nbsp;&nbsp; Dachhöhe &nbsp;&nbsp; <span class="outputRoofHeight">2000mm</span></div>
										<div>C &nbsp;&nbsp; Dachhöhe maximal &nbsp;&nbsp; <span class="outputMaxRoofHeight">2000mm</span></div>
                            ...
                            <div class="col-12 col-lg-8 offset-lg-2">
                                ...
                                <div class="modularinputgroup cnt4 mt-2">
									...
									<div class="col-12 float-start timespanRadio mt-2">
										...
										<label class="radiospanInput" for="rbtn2">in den nächsten 3 Monaten</label>
										<input class="form-check-input " type="radio" name="timespan" id="rbtn2">
										<label class="radiospanInput" for="rbtn3">In den nächsten 6 Monaten</label>
