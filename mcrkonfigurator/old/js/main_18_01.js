...
export var desiredWidthElements = 0;
...
async function init() {
    ...
    LoadTextures(textureLoader, cubemapTextureWithLightprobe);
    ...
    // // diffuseMapHedge = textureLoader.load("textures/maderos/stylized_bush_basecolor.png", function(texture) {
    // // texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
    // // texture.offset.set(0, 0);
    // // texture.repeat.set(1, 1);
    // // texture.encoding = THREE.sRGBEncoding;
    // // });
    // // opacityMapHedge = textureLoader.load("textures/maderos/stylized_bush_opacity.png", function(texture) {
    // // texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
    // // texture.offset.set(0, 0);
    // // texture.repeat.set(1, 1);
    // // texture.encoding = THREE.sRGBEncoding;
    // // });
    // // normalMapHedge = textureLoader.load("textures/maderos/stylized_bush_normal.png", function(texture) {
    // // texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
    // // texture.offset.set(0, 0);
    // // texture.repeat.set(1, 1);
    // // });
    ...
    const meshGround = new THREE.Mesh(new THREE.PlaneGeometry(2000, 2000), materialGrass);
    ...
    https://redstapler.co/load-multiple-model-three-js-promise/
    */

    async function setupDummy() {
        //console.log("setupDummy");
        //load in the dummy fbx model here, "wait" until it's done
        const dummy = await new Promise(loadDummy);
    ...
    function loadDummy(resolve, reject) {
        const fbxLoader = new FBXLoader();
    ...
    //     materialTerrassendachGlatt.envMapIntensity = API.envMapIntensity;
...
async function LoadTextures(textureLoader, cubemapTextureWithLightprobe) {
    diffuseMapTerrassendach = textureLoader.load("textures/maderos/terrassendach_gebuerstet_albedo.jpg", function(texture) {
        texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
        texture.offset.set(0, 0);
        texture.repeat.set(8, 12);
...
function buildTerrassendachObjects() {
    ...
    for (let i = 1; i <= desiredWidthElements; i++) {
        ...
        if (i == 1) {
            ...
            loadTerrassendachTeilMesh("sparrenfestglas_repeat.FBX", materialMetall, true, true, xoffset, metallsparrenPivotYOffset, metallsparrenPivotZOffset, i, "start", "sparrenfestglas", true, true, false, schiebeGlasSelected);
            ...
            // //console.log(i+" last ");
            loadTerrassendachTeilMesh("dachsparren_repeat.FBX", materialTerrassendach, true, true, xoffset, holzsparrenPivotYOffset, holzsparrenPivotZOffset, i, "end", "dachsparren", true, true, false, false);
            loadTerrassendachTeilMesh("dachglas_schiebeglas_repeat.FBX", materialGlassArr, false, false, xoffset, metallsparrenPivotYOffset, metallsparrenPivotZOffset, i, "repeat", "dachglas_schiebeglas", true, true, false, !schiebeGlasSelected);
            loadTerrassendachTeilMesh("dachglas_fest_repeat.FBX", materialGlassArr, false, false, xoffset, metallsparrenPivotYOffset, metallsparrenPivotZOffset, i, "repeat", "dachglas_fest", true, true, false, schiebeGlasSelected);
            loadTerrassendachTeilMesh("sparrenschiebeglas_repeat.FBX", materialMetall, true, true, xoffset, metallsparrenPivotYOffset, metallsparrenPivotZOffset, i, "end", "sparrenschiebeglas", true, true, false, !schiebeGlasSelected);
            loadTerrassendachTeilMesh("sparrenfestglas_repeat.FBX", materialMetall, true, true, xoffset, metallsparrenPivotYOffset, metallsparrenPivotZOffset, i, "end", "sparrenfestglas", true, true, false, schiebeGlasSelected);
            ...
            loadTerrassendachTeilMesh("wandbalken_end.FBX", materialTerrassendach, true, true, xoffset, yoffset, zoffset, i, "end", "wandbalken", false, false, true, false);
            loadTerrassendachTeilMesh("wandmetall_end.FBX", materialMetall, true, true, xoffset, yoffset, zoffset, i, "end", "wandmetall", false, false, true, false);
