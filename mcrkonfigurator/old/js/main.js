                    ...
                    object.traverse(function(child) {
                        if (child.isMesh) {
                            ...
                            if (child.name == "led_row1" || child.name == "led_row2") {
                                ...
                                child.scale.set(initialScale, (initialScale * (1 / currentGlobalScale)), initialScale);
                            }
                        }
                    });
                }
...
async function buildTerrassendachObjects() {
    ...
    for (let i = 1; i <= desiredWidthElements; i++) {
        ...
        */
        ...
        if (!sparrenklaueSelected) {
            extraYOffset = ohneSparrenklaueYOffset; // 0.85
        }


        if (i == 1) {
            // ////console.log(i+" first ");
            loadTerrassendachTeilMesh("dachsparren_repeat.FBX", materialTerrassendach, true, true, xoffset, holzsparrenPivotYOffset + extraYOffset, holzsparrenPivotZOffset, i, "start", "dachsparren", true, true, false, false);
            loadTerrassendachTeilMesh("dachglas_schiebeglas_repeat.FBX", materialGlassArr, false, false, xoffset, metallsparrenPivotYOffset + extraYOffset, metallsparrenPivotZOffset, i, "repeat", "dachglas_schiebeglas", true, true, false, !schiebeGlasSelected);
            loadTerrassendachTeilMesh("dachglas_fest_repeat.FBX", materialGlassArr, false, false, xoffset, metallsparrenPivotYOffset + extraYOffset, metallsparrenPivotZOffset, i, "repeat", "dachglas_fest", true, true, false, schiebeGlasSelected);
            loadTerrassendachTeilMesh("sparrenschiebeglas_start.FBX", materialMetall, true, true, xoffset, metallsparrenPivotYOffset + extraYOffset, metallsparrenPivotZOffset, i, "start", "sparrenschiebeglas", true, true, false, !schiebeGlasSelected);
            loadTerrassendachTeilMesh("sparrenfestglas_start.FBX", materialMetall, true, true, xoffset, metallsparrenPivotYOffset + extraYOffset, metallsparrenPivotZOffset, i, "start", "sparrenfestglas", true, true, false, schiebeGlasSelected);
            ...
            loadTerrassendachTeilMesh("wandbalken_start.FBX", materialTerrassendach, true, true, xoffset, yoffset + extraYOffset, zoffset, i, "start", "wandbalken", false, false, true, false);
            loadTerrassendachTeilMesh("wandmetall_start.FBX", materialMetall, true, true, xoffset, yoffset + extraYOffset, zoffset, i, "start", "wandmetall", false, false, true, false);
            loadTerrassendachTeilMesh("rinne_start.FBX", materialRinne, true, true, xoffset, yoffset + extraYOffset, zoffset, i, "start", "rinne", true, false, false, false);
            loadTerrassendachTeilMesh("dachueberstand_start.FBX", materialGlassArr, false, false, xoffset, metallsparrenPivotYOffset + extraYOffset, metallsparrenPivotZOffset, i, "start", "dachueberstand", true, true, false, !dachueberstandSelected);
            loadTerrassendachTeilMesh("stoffbahn_repeat.FBX", materialStoffbahnArr, true, true, xoffset, holzsparrenPivotYOffset + extraYOffset, holzsparrenPivotZOffset, i, "repeat", "stoffbahn", true, true, false, !stoffbahnenSelected);
            loadTerrassendachTeilMesh("led_row.FBX", materialLedArr, false, false, xoffset, holzsparrenPivotYOffset + extraYOffset, holzsparrenPivotZOffset, i, "repeat", "led_row", true, true, false, !ledSelected);
        } else {

            // bis zum vorletzten - wegen frontbalken 
            if (i < desiredWidthElements) {
                loadTerrassendachTeilMesh("dachsparren_repeat.FBX", materialTerrassendach, true, true, xoffset, holzsparrenPivotYOffset + extraYOffset, holzsparrenPivotZOffset, i, "repeat", "dachsparren", true, true, false, false);
                loadTerrassendachTeilMesh("dachglas_schiebeglas_repeat.FBX", materialGlassArr, false, false, xoffset, metallsparrenPivotYOffset + extraYOffset, metallsparrenPivotZOffset, i, "repeat", "dachglas_schiebeglas", true, true, false, !schiebeGlasSelected);
                loadTerrassendachTeilMesh("dachglas_fest_repeat.FBX", materialGlassArr, false, false, xoffset, metallsparrenPivotYOffset + extraYOffset, metallsparrenPivotZOffset, i, "repeat", "dachglas_fest", true, true, false, schiebeGlasSelected);
                loadTerrassendachTeilMesh("sparrenschiebeglas_repeat.FBX", materialMetall, true, true, xoffset, metallsparrenPivotYOffset + extraYOffset, metallsparrenPivotZOffset, i, "repeat", "sparrenschiebeglas", true, true, false, !schiebeGlasSelected);
                loadTerrassendachTeilMesh("sparrenfestglas_repeat.FBX", materialMetall, true, true, xoffset, metallsparrenPivotYOffset + extraYOffset, metallsparrenPivotZOffset, i, "repeat", "sparrenfestglas", true, true, false, schiebeGlasSelected);
                ...
                loadTerrassendachTeilMesh("wandbalken_repeat.FBX", materialTerrassendach, true, true, xoffset, yoffset + extraYOffset, zoffset, i, "repeat", "wandbalken", false, false, true, false);
                loadTerrassendachTeilMesh("wandmetall_repeat.FBX", materialMetall, true, true, xoffset, yoffset + extraYOffset, zoffset, i, "repeat", "wandmetall", false, false, true, false);
                loadTerrassendachTeilMesh("rinne_repeat.FBX", materialRinne, true, true, xoffset, yoffset + extraYOffset, zoffset, i, "repeat", "rinne", true, false, false, false);
                loadTerrassendachTeilMesh("stoffbahn_repeat.FBX", materialStoffbahnArr, true, true, xoffset, holzsparrenPivotYOffset + extraYOffset, holzsparrenPivotZOffset, i, "repeat", "stoffbahn", true, true, false, !stoffbahnenSelected);
                loadTerrassendachTeilMesh("led_row.FBX", materialLedArr, false, false, xoffset, holzsparrenPivotYOffset + extraYOffset, holzsparrenPivotZOffset, i, "repeat", "led_row", true, true, false, !ledSelected);
            } else {
                loadTerrassendachTeilMesh("dachsparren_repeat.FBX", materialTerrassendach, true, true, xoffset, holzsparrenPivotYOffset + extraYOffset, holzsparrenPivotZOffset, i, "repeat", "dachsparren", true, true, false, false);
                ...
                loadTerrassendachTeilMesh("sparrenschiebeglas_repeat.FBX", materialMetall, true, true, xoffset, metallsparrenPivotYOffset + extraYOffset, metallsparrenPivotZOffset, i, "repeat", "sparrenschiebeglas", true, true, false, !schiebeGlasSelected);
                loadTerrassendachTeilMesh("sparrenfestglas_repeat.FBX", materialMetall, true, true, xoffset, metallsparrenPivotYOffset + extraYOffset, metallsparrenPivotZOffset, i, "repeat", "sparrenfestglas", true, true, false, schiebeGlasSelected);
                loadTerrassendachTeilMesh("frontbalken_end.FBX", materialTerrassendach, true, true, xoffset, yoffset, zoffset, i, "end", "frontbalken", false, false, false, false);
                loadTerrassendachTeilMesh("wandbalken_end.FBX", materialTerrassendach, true, true, xoffset, yoffset + extraYOffset, zoffset, i, "end", "wandbalken", false, false, true, false);
                loadTerrassendachTeilMesh("wandmetall_end.FBX", materialMetall, true, true, xoffset, yoffset + extraYOffset, zoffset, i, "end", "wandmetall", false, false, true, false);
                // loadTerrassendachTeilMesh("rinne_repeat.FBX", materialRinne, true, true, xoffset, yoffset + extraYOffset, zoffset, i, "repeat", "rinne", true, false, false, false);
                loadTerrassendachTeilMesh("stoffbahn_repeat.FBX", materialStoffbahnArr, true, true, xoffset, holzsparrenPivotYOffset + extraYOffset, holzsparrenPivotZOffset, i, "repeat", "stoffbahn", true, true, false, !stoffbahnenSelected);
                loadTerrassendachTeilMesh("led_row.FBX", materialLedArr, false, false, xoffset, holzsparrenPivotYOffset + extraYOffset, holzsparrenPivotZOffset, i, "repeat", "led_row", true, true, false, !ledSelected);
            }
        ...
        if (i == desiredWidthElements) {
            ...
            */
            ...
            if (currentPolePositionIsEingerueckt) {
                loadTerrassendachTeilMesh("rinne_eingerueckt_end.FBX", materialRinne, true, true, xoffset, yoffset + extraYOffset, zoffset, i, "end", "rinneeingerueckt", true, false, false, false);
            } else {
                loadTerrassendachTeilMesh("rinne_end.FBX", materialRinne, true, true, xoffset, yoffset + extraYOffset, zoffset, i, "end", "rinne", true, false, false, false);
            }

            xoffset = (i - 1) * gridsizeW + 0.7;
            loadTerrassendachTeilMesh("dachsparren_end.FBX", materialTerrassendach, true, true, xoffset, holzsparrenPivotYOffset + extraYOffset, holzsparrenPivotZOffset, i, "end", "dachsparren", true, true, false, false);
            ...
            // // // // // loadTerrassendachTeilMesh("wandstuetze.FBX", materialTerrassendach, true, true, xoffset, yoffset + extraYOffset, zoffset, i, "end", "wandstuetze", false, false, true, !wandstuetzeSelected);
            //xoffset = i * gridsizeW - 0.35;

            xoffset = i * gridsizeW;
            // xoffset = i * gridsizeW - 0.7;
            loadTerrassendachTeilMesh("sparrenschiebeglas_end.FBX", materialMetall, true, true, xoffset, metallsparrenPivotYOffset + extraYOffset, metallsparrenPivotZOffset, i, "end", "sparrenschiebeglas", true, true, false, !schiebeGlasSelected);
            loadTerrassendachTeilMesh("sparrenfestglas_end.FBX", materialMetall, true, true, xoffset, metallsparrenPivotYOffset + extraYOffset, metallsparrenPivotZOffset, i, "end", "sparrenfestglas", true, true, false, schiebeGlasSelected);
            loadTerrassendachTeilMesh("dachueberstand_end.FBX", materialGlassArr, false, false, xoffset, metallsparrenPivotYOffset + extraYOffset, metallsparrenPivotZOffset, i, "end", "dachueberstand", true, true, false, !dachueberstandSelected);
            loadTerrassendachTeilMesh("led_row.FBX", materialLedArr, false, false, xoffset, holzsparrenPivotYOffset + extraYOffset, holzsparrenPivotZOffset, i, "repeat", "led_row", true, true, false, !ledSelected);
        }
    } // for loop end
    ...
    if (desiredWidthElements == 8) {
        if (currentPolePositionIsEingerueckt) {
            loadTerrassendachTeilMesh("stuetze.FBX", materialTerrassendach, true, true, (4 * gridsizeW), 0, 0, 4, "extra", "stuetze", false, false, false, true);
        } else {
            loadTerrassendachTeilMesh("stuetze.FBX", materialTerrassendach, true, true, (4 * gridsizeW), 0, 0, 4, "extra", "stuetze", false, false, false, false);
        }
    }
...
function action_camposition_1() {
    ...
    tweenCameraFov(camera, cameraFirstpersonFov, cameraDefaultFov, 1000); // cameraFirstpersonFov to cameraDefaultFov	
}
...
function action_camposition_2() {
    ...
    tweenCameraFov(camera, cameraDefaultFov, cameraFirstpersonFov, 1000);
}
